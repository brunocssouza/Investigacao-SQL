  ...
  return (
    <div className="space-y-8 animate-fade-in">
        ...
        <div className="grid items-center gap-6 md:grid-cols-2">
          <div>
            ...
            <p className="text-justify text-slate-300">
              ...
              <i>
                ...
                restaram como fonte de pistas.
              </i>
              <br />
              <br />A investigação interna indica que um funcionário do museu
              foi o responsável — alguém com acesso restrito, conhecimento
              técnico e um álibi falso.
            </p>
          </div>
          <div className="flex items-center justify-center">
            <img
              ...
              className="max-h-48 drop-shadow-2xl animate-float"
            />
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="glass-card p-4 md:p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
            ...
            <ul className="text-slate-300">
              <li>
                Descobrir quem roubou o diamante e quais evidências indicam o
                culpado.
              </li>
            </ul>
          </div>
          <div className="glass-card p-4 md:p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
            ...
            <ul className="space-y-1 text-slate-300">
              <li>
                <strong>funcionarios</strong> — Identifica cada funcionário e
                cargo.
              </li>
              <li>
                <strong>salas</strong> — Mostra as localizações e nomes das
                áreas.
              </li>
              <li>
              ...
              <li>
                <strong>acessos</strong> — Registra horários e locais de
                entrada/saída.
              </li>
              <li>
                <strong>movimentacoes</strong> — Mostra quando itens foram
                movidos ou manipulados.
              </li>
              <li>
                <strong>depoimentos</strong> — Declarações dos funcionários.
              </li>
              <li>
                <strong>permissoes</strong> — Que funcionario tem permissao a
                qual sala.
              </li>
            </ul>
          </div>
      ...
      <section className="glass-section p-6 md:p-8">
        ...
        <h2 className="mb-2 font-bold text-slate-100 mt-8">
          Bloco de Anotações
        </h2>
      ...
      {rows && (
        <section
          id="resultado"
          className="glass-section p-4 md:p-6 animate-fade-in-up"
        >
          {rows.length === 0 ? (
